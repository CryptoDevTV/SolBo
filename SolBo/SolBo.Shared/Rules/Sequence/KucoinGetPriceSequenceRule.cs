...
{
    public class KucoinGetPriceSequenceRule : ISequencedRule
    {
        public string SequenceName => "BINANCE-PRICE";
        private readonly IKucoinTickerService _tickerPriceService;
        public KucoinGetPriceSequenceRule(IKucoinTickerService tickerPriceService)
        {
